...
# 32bit
chmod 644 $RPM_BUILD_ROOT%{_prefix}/%{libdirname}/libpython%{libvers}*
########
# Tools
...
# 32bit
%{_prefix}/lib/python2.7/lib-dynload/
%{_prefix}/lib/pkgconfig/python-2.7.pc
...
# 32bit
%{_prefix}/%{libdirname}/python%{libvers}/config
